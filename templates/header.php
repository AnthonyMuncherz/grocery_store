            ...
            theme: {
                extend: {
                    colors: {
                        ...
                        // You can add more theme colors here if needed
                    }
                }
            }
        }
...
<body class="bg-gray-100 flex flex-col min-h-screen">
    <nav class="bg-malaysia-blue shadow-md sticky top-0 z-50">
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        <a class="text-gray-300 hover:bg-malaysia-blue-dark hover:text-white px-3 py-2 rounded-md text-sm font-medium <?php echo $current_module === 'home' ? 'bg-malaysia-blue-dark text-white' : ''; ?>"
                            href="index.php">
                            <i class="fas fa-home mr-1"></i> Home
                        </a>
                        <a class="text-gray-300 hover:bg-malaysia-blue-dark hover:text-white px-3 py-2 rounded-md text-sm font-medium <?php echo $current_module === 'products' ? 'bg-malaysia-blue-dark text-white' : ''; ?>"
                            href="index.php?module=products">
                            <i class="fas fa-shopping-basket mr-1"></i> Products
                        </a>
                        <a class="text-gray-300 hover:bg-malaysia-blue-dark hover:text-white px-3 py-2 rounded-md text-sm font-medium <?php echo $current_module === 'orders' ? 'bg-malaysia-blue-dark text-white' : ''; ?>"
                            href="index.php?module=orders">
                            <i class="fas fa-receipt mr-1"></i> Orders
                        </a>
                        <a class="text-gray-300 hover:bg-malaysia-blue-dark hover:text-white px-3 py-2 rounded-md text-sm font-medium <?php echo $current_module === 'inventory' ? 'bg-malaysia-blue-dark text-white' : ''; ?>"
        ...
        <div class="md:hidden hidden" id="mobile-menu">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <a href="index.php"
                    class="text-gray-300 hover:bg-malaysia-blue-dark hover:text-white block px-3 py-2 rounded-md text-base font-medium <?php echo $current_module === 'home' ? 'bg-malaysia-blue-dark text-white' : ''; ?>">
                    <i class="fas fa-home mr-2"></i>Home
                </a>
                <a href="index.php?module=products"
                    class="text-gray-300 hover:bg-malaysia-blue-dark hover:text-white block px-3 py-2 rounded-md text-base font-medium <?php echo $current_module === 'products' ? 'bg-malaysia-blue-dark text-white' : ''; ?>">
                    <i class="fas fa-shopping-basket mr-2"></i>Products
                </a>
                <a href="index.php?module=orders"
                    class="text-gray-300 hover:bg-malaysia-blue-dark hover:text-white block px-3 py-2 rounded-md text-base font-medium <?php echo $current_module === 'orders' ? 'bg-malaysia-blue-dark text-white' : ''; ?>">
                    <i class="fas fa-receipt mr-2"></i>Orders
                </a>
                <a href="index.php?module=inventory"
                    class="text-gray-300 hover:bg-malaysia-blue-dark hover:text-white block px-3 py-2 rounded-md text-base font-medium <?php echo $current_module === 'inventory' ? 'bg-malaysia-blue-dark text-white' : ''; ?>">
